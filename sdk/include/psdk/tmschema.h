...
BEGIN_TM_PART_STATES(TASKDIALOG_CONTENTPANE)
    TM_PART(1, TDLGCPS, STANDALONE)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(TASKDIALOG_EXPANDOBOUTTON)
...
BEGIN_TM_CLASS_PARTS(NAVIGATION)
    TM_STATE(1, NAV, BACKBUTTON)
    TM_STATE(2, NAV, FORWARDBUTTON)
    TM_STATE(3, NAV, MENUBUTTON)
END_TM_CLASS_PARTS()

BEGIN_TM_PART_STATES(NAV_BACKBUTTON)
    TM_STATE(1, NAV_BB, NORMAL)
    TM_STATE(2, NAV_BB, HOT)
    TM_STATE(3, NAV_BB, PRESSED)
    TM_STATE(4, NAV_BB, DISABLED)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(NAV_FORWARDBUTTON)
    TM_STATE(1, NAV_FB, NORMAL)
    TM_STATE(2, NAV_FB, HOT)
    TM_STATE(3, NAV_FB, PRESSED)
    TM_STATE(4, NAV_FB, DISABLED)
END_TM_PART_STATES()

BEGIN_TM_PART_STATES(NAV_MENUBUTTON)
    TM_STATE(1, NAV_MB, NORMAL)
    TM_STATE(2, NAV_MB, HOT)
    TM_STATE(3, NAV_MB, PRESSED)
    TM_STATE(4, NAV_MB, DISABLED)
END_TM_PART_STATES()
